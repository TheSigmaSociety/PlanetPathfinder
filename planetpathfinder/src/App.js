...
const SolarSystem = () => {
  ...
  // Array to keep track of selected planets
  let selectedPlanets = ["temp", "temp", "temp", "temp", "temp", "temp", "temp", "temp"];

  // Function to select planets and add a class to them
    ...
    <div className="parent-container">
      ...
      <div className="solar-system-container">
        ...
        {!loading && <div className="stepContainer">
          <div className="step uno"></div>
          <div className="step dos"></div>
          <div className="step tres"></div>
          <div className="step quatro"></div>
          <div className="step cinco"></div>
          <div className="step seis"></div>
          <div className="step siete"></div>
        </div>}
      </div>
    </div>
  );
